...
static VkFilter filter_to_vk(Purrr_Sampler_Filter filter);
...
static VkSamplerAddressMode sampler_address_mode_to_vk(Purrr_Sampler_Address_Mode addressMode) {
  ...
  case PURRR_SAMPLER_ADDRESS_MODE_MIRROR: return VK_SAMPLER_ADDRESS_MODE_MIRRORED_REPEAT;
...
static VkBorderColor sampler_border_color_to_vk(Purrr_Sampler_Border_Color borderColor) {
  switch (borderColor) {
  case PURRR_SAMPLER_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK: return VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK;
  case PURRR_SAMPLER_BORDER_COLOR_INT_TRANSPARENT_BLACK: return VK_BORDER_COLOR_INT_TRANSPARENT_BLACK;
  case PURRR_SAMPLER_BORDER_COLOR_FLOAT_OPAQUE_BLACK: return VK_BORDER_COLOR_FLOAT_OPAQUE_BLACK;
  case PURRR_SAMPLER_BORDER_COLOR_INT_OPAQUE_BLACK: return VK_BORDER_COLOR_INT_OPAQUE_BLACK;
  case PURRR_SAMPLER_BORDER_COLOR_FLOAT_OPAQUE_WHITE: return VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE;
  case PURRR_SAMPLER_BORDER_COLOR_INT_OPAQUE_WHITE: return VK_BORDER_COLOR_INT_OPAQUE_WHITE;
