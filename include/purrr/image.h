...
EXPORT Purrr_Result purrr_create_image(Purrr_Context context, Purrr_Image_Create_Info createInfo, Purrr_Image *image);
EXPORT Purrr_Result purrr_destroy_image(Purrr_Image image);
