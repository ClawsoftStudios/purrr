...
EXPORT Purrr_Result purrr_create_context(Purrr_Backend backend, Purrr_Context_Create_Info createInfo, Purrr_Context *context);
EXPORT Purrr_Result purrr_destroy_context(Purrr_Context context);
