...
EXPORT Purrr_Result purrr_create_sampler(Purrr_Context context, Purrr_Sampler_Create_Info createInfo, Purrr_Sampler *sampler);
EXPORT Purrr_Result purrr_destroy_sampler(Purrr_Sampler sampler);
